...
# build it using g++
index : index.o skippedlist.o
	g++ -o index -g index.o skippedlist.o
...
index.o : index.cc skippedlist.h
	g++ -Wall -c -g index.cc
	
skippedlist.o : skippedlist.cc skippedlist.h 
	g++ -Wall -c -g skippedlist.cc 
